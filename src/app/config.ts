...
export class Config {
    ...
    constructor() {
        ...
        this.url = 'https://zoopme.com/'; // Replace URL_PLACEHOLDER with you site url (http://example.com)
        this.consumerKey = 'ck_ba1683cc1bee0e86db9517473c3b865b60cd56da'; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_key
        this.consumerSecret = 'cs_ca16a9a611138c7ce6985eb22720b400d8685cf0'; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_secret
